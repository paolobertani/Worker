...
define( 'WORKER_INTERVAL_MARKDOWN',         15 );   // Check markdown pages generation
define( 'WORKER_MARKDOWN_PAGE_BATCH',       20 );   // How many PDF pages Docling will process per iteration
define( 'WORKER_MARKDOWN_LOCK', 'worker markdown' ); // Document lock while markdown pages are being generated
...
define( 'WORKER_CACHE_COMPARE_SOURCE_DPI',  348 );   // Cached page dpi used as source for adaptive keep/discard decision
define( 'WORKER_CACHE_COMPARE_TARGET_DPI',  216 );   // Target dpi used to measure resize from cache
define( 'WORKER_CACHE_COMPARE_QUALITY',    0.85 );   // JPEG quality used for adaptive keep/discard decision at target dpi
define( 'WORKER_CACHE_COMPARE_RATIO',      1.20 );   // Discard cached page when render milliseconds are below resize milliseconds * ratio
